...
cmd1= f'sudo {package} install lftp -y; mkdir -p ~/.cron; cp backup_upload.sh ~/.cron/ && (crontab -l; echo "{syntaxe} sh /home/{user}/.cron/backup_upload.sh {user} {pwd} {host} {datestr}") | sort - | uniq - | crontab -'
